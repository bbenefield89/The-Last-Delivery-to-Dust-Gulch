...
const DEFAULT_HAS_CROSSED_FINISH_LINE := false
...
var has_crossed_finish_line: bool = DEFAULT_HAS_CROSSED_FINISH_LINE
...
func reset_for_new_run() -> void:
	...
	has_crossed_finish_line = DEFAULT_HAS_CROSSED_FINISH_LINE
