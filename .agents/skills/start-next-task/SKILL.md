...
2. If there is an active `Doing` ticket:
   ...
   - After completing any single step implementation, report the summary as usual and wait for review or confirmation before beginning the next step.
...
8. After completing the step implementation, report what was changed, include a short player-facing summary of the in-game or in-editor result, and include a focused `Manual Verification` section in the report for the human reviewer.
   - The player-facing summary must describe the result in normal language, not just the files changed or the code written. Example: `Added a shrub to the scenery.`
...
- The implementation report must include a short summary of the player-visible or editor-visible result of the change, not just a file or code summary.
...
- The implementation report includes a short player-facing summary of the in-game or in-editor result of the step.
